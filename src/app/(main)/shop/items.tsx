  ...
  return (
    <ul className="w-full">
      <div className="flex w-full items-center gap-x-4 border-t-2 p-4">
        <Image src={ImgHeart} alt="Hearts" height={60} width={60} />
        ...
        >
          {hearts === 5 ? (
            ...
            <div className="flex items-center">
              <Image src={ImgPoints} alt="Points" height={20} width={20} />
      ...
      <div className="flex w-full items-center gap-x-4 border-t-2 p-4 pt-8">
        <Image src={ImgUnlimited} alt="unlimited" height={60} width={60} />
