    ...
    return (
        <div>
            <section className="min-h-screen px-60 max-2xl:px-40 max-xl:px-20 max-md:px-10 max-sm:px-6">
                ...
                <SectionHome.Root
                    imageUrl="/Questions-bro.svg" /* default: imagePosition="right" */
                >
                    <SectionHome.Title>
                    ...
                    <SectionHome.Paragraph>
                        ...
                        desafiadores. Compartilhe com seus amigos e veja quem se
                        sai melhor. Boa sorte e aproveite a jornada de
                        aprendizado!
                    </SectionHome.Paragraph>
