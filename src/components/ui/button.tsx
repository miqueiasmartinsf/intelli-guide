    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                sidebar:
                    "bg-transparent text-slate-500 border-2 border-transparent hover:bg-green-500/25 transition-none",
                sidebarOutline:
                    "bg-primary text-white border-primary border-2 transition:none",
                locked: "bg-neutral-200 text-primary-foreground hover:bg-neutral-200/90 border-neutral-400 border-b-4 active-border-bb-0",
            },
            size: {
